  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(`Failed to generate image. Server responded with status ${response.status}: ${errorText}`);
      }
      ...
      if (!imageUrl) {
        ...
        throw new Error('No image URL returned from Spectrum API.');
      }
